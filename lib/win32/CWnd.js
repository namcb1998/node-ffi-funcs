const {user32, gdi32, ffihelper, user32Custom} = require('./dll')
...
class CWnd {
  ...
  static FindWindowCustom(className = null, windowName = null) {
    return user32Custom.FindWindowW(CString(className), CString(windowName));
  }
  ...
  static FindWindowExCustom(hParent = null, hChild = null, className = null, windowName = null) {
    return user32Custom.FindWindowExW(hParent, hChild, CString(className), CString(windowName));
  }
  ...
  static SendMessageCustom(hWnd, Msg, wParam, lParam) {
    return user32Custom.SendMessageW(hWnd, Msg, wParam, LParam(lParam))
  }
